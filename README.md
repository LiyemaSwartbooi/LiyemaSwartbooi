...
- **Application:** TypeScript, Next.js App Router, React, Node.js, native app development, Tailwind CSS, shadcn/ui, base-ui, framer-motion
...
- **Platform and payments:** Stripe and Stripe Connect, Clerk, Resend, Vercel
- **Architecture:** multi-tenant SaaS, role-based access control, approval and audit flows, two-sided marketplaces, document generation pipelines from markdown to branded PDF and WCAG-AA HTML, POPIA-aware design
